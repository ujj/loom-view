...
*   **Dual-Track Date Engine:**
    ...
    *   Custom: Supports fictional calendars (e.g., Era 1: 450) while maintaining correct mathematical positioning.
*   **Note-Style Hierarchy:** Visually distinguish between long-term Thematic eras (striped backgrounds) and specific Event "knots" (solid blocks).
*   **Fully Configurable:** Customize your zoom increments (Year/Decade/Century), era-jump bookmarks, and lane ordering.
...
1.  **The Metadata Schema**
    ...
    year-end: -44             # Optional: Your End Date
    note-style: event         # 'event' (solid) or 'thematic' (striped)
    key-figures: [Caesar]     # Used for the 'Entity Glow' connection
    ```
